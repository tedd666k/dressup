export type Product = { id: string; name: string; price: number; stock: number; image: string };

export const DEFAULT_PRODUCTS: Product[] = [
  { id: "mk-aline", name: "A‑Line Classic", price: 850, stock: 6, image: "https://images.pexels.com/photos/25650913/pexels-photo-25650913.jpeg" },
